...
// Defaults
#define JWG_CIRCLE_COLOR_DEFAULT [NSColor colorWithRed:239/255.0f green:101/255.0f blue:48/255.0f alpha:1]
#define JWG_CIRCLE_BACKGROUND_COLOR_DEFAULT [NSColor colorWithWhite:.85f alpha:1]
#define JWG_CIRCLE_FILL_COLOR_DEFAULT [NSColor clearColor]
...
@property (nonatomic, strong) NSColor *circleBackgroundColor;

/// The color of inside of the circle - default is JWG_CIRCLE_FILL_COLOR_DEFAULT.
@property (nonatomic, strong) NSColor *circleFillColor;
